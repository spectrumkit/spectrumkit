...
This project uses [`pnpm`](https://pnpm.io) as a package manager. Use `corepack enable pnpm` to install the required `pnpm` version to get started.
...
- Select the latest version tag for `@spectrumkit/spectrumkit`.
- Set the title to `@spectrumkit/spectrumkit@x.x.x` (substituting the latest version)
...
- Go to [GitHub’s new release form.](https://github.com/rainbow-me/rainbowkit/releases/new)
- Select the latest version tag for `@spectrumkit/spectrumkit-siwe-next-auth`.
- Set the title to `@spectrumkit/spectrumkit-siwe-next-auth@x.x.x` (substituting the latest version)
...
- Go to [GitHub’s new release form.](https://github.com/rainbow-me/rainbowkit/releases/new)
- Select the latest version tag for `@spectrumkit/create-spectrumkit`.
- Set the title to `@spectrumkit/create-spectrumkit@x.x.x` (substituting the latest version)
...
- Go to [GitHub’s new release form.](https://github.com/rainbow-me/rainbowkit/releases/new)
- Select the latest version tag for `@spectrumkit/spectrum-button`.
- Set the title to `@spectrumkit/spectrum-button@x.x.x` (substituting the latest version)
