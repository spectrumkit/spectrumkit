...
description: Sebuah library plug-and-play untuk Wagmi untuk mendukung dompet Rainbow di dApp Anda
...
**1. Install `@spectrumkit/spectrum-button` dan dependensi sejajarnya**
