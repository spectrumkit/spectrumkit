...
```bash
npm install @spectrumkit/spectrumkit wagmi@3 viem@2 @tanstack/react-query
```
...
RainbowKit works with both [Turbopack](https://nextjs.org/docs/app/api-reference/turbopack) (the default bundler in Next.js 16+) and [webpack](https://nextjs.org/docs/app/api-reference/config/next-config-js/webpack).
