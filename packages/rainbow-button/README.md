...
Install the `@spectrumkit/spectrum-button` package and its peer dependencies, [wagmi](https://wagmi.sh/), [viem](https://viem.sh/), and [@tanstack/react-query](https://tanstack.com/query/v5).
...
```tsx
import { useRainbowConnectModal } from '@spectrumkit/spectrum-button';
