...
export function ConnectButton(props: ConnectButtonProps) {
  // ConnectButton depends on wagmi's Config context via `useConnectionStatus`
  // and `ConnectButtonRenderer`, both of which throw on SSR. Render nothing
  // until the client has mounted; the button re-renders normally on hydration.
  const mounted = useIsMounted();
  if (!mounted) return null;
  return <ConnectButtonClient {...props} />;
}
